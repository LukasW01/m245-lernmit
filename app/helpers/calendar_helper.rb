module CalendarHelper
  def event_position(due_date, backward_minutes = 120)
    calendar_start_time = 6 * 60
    calendar_end_time = 20 * 60
    fractions_per_minute = 350.0 / (calendar_end_time - calendar_start_time)

    event_start_minutes = (due_date.hour * 60) + due_date.min - backward_minutes
    event_end_minutes = (due_date.hour * 60) + due_date.min + 60 - backward_minutes
